...
//
// A minimal, dependency-free grayscale PNG writer used only to dump
// golden-test mismatches for a human to look at. It is never part of a
// pass/fail assertion: the golden tests compare raw bytes, which needs no
// image library at all.

#ifndef HAC_TESTS_PNG_WRITE_H
#define HAC_TESTS_PNG_WRITE_H
